...
public class PointController {
    ...
    @DeleteMapping("/purchase/{itemId}")
    public ResponseEntity<PointDto.PurchaseResponse> cancelPurchase(
            @AuthenticationPrincipal Long userId,
            @PathVariable Long itemId) {
        return ResponseEntity.ok(pointService.cancelPurchase(userId, itemId));
    }
}
